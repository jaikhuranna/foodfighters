...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <a href="index.html" class="navbar-brand mx-auto mx-lg-0">Food Fighters</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-lg-5">
                    ...
                    <li class="nav-item">
                        <a class="nav-link click-scroll" href="#section_5"></a>
                    </li>
                </ul>
                    ...
                    <div class="col-lg-7 col-12">
                        <div class="hero-text">
                            <div class="hero-title-wrap d-flex align-items-center mb-4">
                                <!-- <img src="happy-bearded-young-man.jpg" class="avatar-image avatar-image-large img-fluid"
                                    alt=""> -->

                                <h1 class="hero-title ms-3 mb-0">Welcome!</h1>
                            </div>

                            <h2 class="mb-4">Fuel your body with the best.</h2>
                            <p class="mb-4"><a class="custom-btn btn custom-link" href="#section_5">Let's begin</a></p>
                        </div>
                    </div>

                    <div class="col-lg-5 col-12 position-relative">
                        <div class="hero-image-wrap"></div>
                        <img src="portrait-happy-excited-man-holding-laptop-computer.png" class="hero-image img-fluid"
                            alt="">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                        <div class="about-thumb">
                            ...
                            <div class="section-title-wrap d-flex justify-content-end align-items-center py-4 mb-4">
                                <h2 class="text-white me-4 mb-0">What We Do</h2>

                                <!-- <img src="happy-bearded-young-man.jpg" class="avatar-image img-fluid" alt=""> -->
                            </div>

                            <h3 class="pt-2 mb-3">a little bit about FoodFighters</h3>

                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptas inventore quibusdam
                                aliquam recusandae maxime repellendus voluptates magni, quam atque omnis sed laudantium.
                            </p>

                            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eveniet officia ratione dolore
                                voluptatibus quod, pariatur expedita, nesciunt, magni et amet facilis nobis laboriosam
                                natus laborum iusto ipsa ullam fugit maiores voluptatum dignissimos.
                            </p>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-12 mx-auto">
                        <div class="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                            <img src="handshake-man-woman-after-signing-business-contract-closeup.jpg"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="projects-thumb">
                            ...
                            <a href="projects/nikhil-KO4io-eCAXA-unsplash.jpg" class="popup-image">
                                <img src="projects/nikhil-KO4io-eCAXA-unsplash.jpg" class="projects-image img-fluid"
                                alt="">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="projects-thumb">
                            ...
                            <a href="projects/the-5th-IQYR7N67dhM-unsplash.jpg" class="popup-image">
                                <img src="projects/the-5th-IQYR7N67dhM-unsplash.jpg" class="projects-image img-fluid"
                                alt="">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="projects-thumb">
                            ...
                            <a href="projects/true-agency-9Bjog5FZ-oc-unsplash.jpg" class="popup-image">
                                <img src="projects/true-agency-9Bjog5FZ-oc-unsplash.jpg"
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-12 col-12">
                        <h3 class="text-center mb-5 py-2">Companies I've had worked</h3>
                    </div>

                    <div class="col-lg-2 col-4 ms-auto clients-item-height">
                        <img src="cachet.svg" class="clients-image img-fluid" alt="">
                    </div>

                    <div class="col-lg-2 col-4 clients-item-height">
                        <img src="guitar-center.svg" class="clients-image img-fluid" alt="">
                    </div>

                    <div class="col-lg-2 col-4 clients-item-height">
                        <img src="tokico.svg" class="clients-image img-fluid" alt="">
                    </div>

                    <div class="col-lg-2 col-4 clients-item-height">
                        <img src="shopify.svg" class="clients-image img-fluid" alt="">
                    </div>

                    <div class="col-lg-2 col-4 me-auto clients-item-height">
                        <img src="profil-rejser.svg" class="clients-image img-fluid" alt="">
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-8 col-12">
                        <div class="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                            <img src="aerial-view-man-using-computer-laptop-wooden-table.jpg"
                                class="avatar-image img-fluid" alt="">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-8 col-12">
                        <div class="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                            ...
                            <h2 class="text-white ms-4 mb-0">Ask Away</h2>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                        <div class="container">
                            <form action=<?=$_SERVER['REQUEST_URI']?> method="post">
                                <p><br>
                                    <br>
                                <p>Your Ingredient of choice?<br>
                                    ...
                                    <br>
                                    <br>
                                <p>Ailment You're Suferring From?<br>
...
?>
        ...
        // print_r($filler);
        $recipe_name = $filler->{'Recipe'};

        if($recipe_name =="" || $recipe_name == " "){
            $recipe_name = "No, we do not reccomend you eat this";

        }else{
            $recipe_name = "Try  ".$recipe_name;
        }
        
        ?>


        <section class="featured d-flex section-padding">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="profile-thumb">
                            <div class="profile-title">
                                <h4 class="mb-0 pl-">Result</h4>
                            </div>

                            <div class="profile-body">
                                <p>
                                    <span class="profile-small-title">Ailment </span>
                                    <span><?=$disease_name?></span>
                                </p>

                                <p>
                                    <span class="profile-small-title">Ingredient</span>
                                    <span><?=$ingredient_name?></span>
                                </p>

                                <p>
                                    <span class="profile-small-title">Recipe Recommended</span>
                                    <span><a href="tel: 305-240-9671"><?=$recipe_name?></a></span>
                                </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-12">
                    <div class="copyright-text-wrap">
                        <p class="mb-0">
                            <span class="copyright-text">Design:
                                <a rel="sponsored" href="https://www.instagram.com/ik_404/" target="_blank">Ishaan
                                    Khurana</a></span>
                            <span class="copyright-text">Design:
                                <a rel="sponsored" href="https://www.instagram.com/ik_404/" target="_blank">Jai
                                    Khurana</a></span>
                            Design:
                            <a rel="sponsored" href="https://www.instagram.com/ik_404/" target="_blank">Parth
                                bhargava</a>
                        </p>
                    </div>
                </div>
